...
const TributoVisualization = () => {
  ...
  const tributosFiltrados = tributos.filter((tributo) =>
    tributo.nome.toLowerCase().includes(filtro.toLowerCase()),
  );
    ...
    <div className={styles.content}>
      ...
      <div className={styles.navigation}>
        <div className={styles.inputWrapper}>
          ...
          <input
            type="text"
            placeholder="Procure por nome do tributo"
            value={filtro}
              ...
              <tr key={tributo.id}>
                ...
                <td>
                  <FaInfoCircle
                    ...
                    onClick={() => openTributoInfo(tributo)}
                  />
                </td>
              </tr>
            ))
